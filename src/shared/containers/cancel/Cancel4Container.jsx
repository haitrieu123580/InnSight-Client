      ...
      {invoice.map((item, index) => (
        ...
        <div className="mb-3 ml-10 text-lg mt-4 mr-10">
          ...
          <div className="flex gap-3 mb-4">
            ...
            <h2>
              Bạn có thể đã bị trừ tiền cho toàn bộ hoặc 1 phần đặt phòng bởi {item.name_hotel} - điều này hoàn toàn bình thường. Tiền hoàn lại thường mất 10 - 15 ngày làm việc.
            </h2>
          </div>
        </div>
        <div className='border bg-green-100 '>
          <Row className='m-4 text-xl'>
            ...
            {charged ? (
              ...
              <h2 className='text-lg mb-4 font-bold text-red-600'>{item.cancel_charge} VND</h2>
              <h2 className='text-lg font-bold text-green-600'>{item.amount - item.cancel_charge} VND</h2>
              </Col>
            ):(
              <Col flex={3} className='text-right mr-40'>
